...
const ContentHeader: React.FC = () => {
    ...
    return (
        <div className="relative mb-8 w-full">
          ...
          text-transparent                      
          inline-block text-4xl md:text-6xl text-center">Content Library</h1>
                </div>
                ...
                <div className="relative inline-block sm:w-auto mt-4 ml-2"> {/* Added margin-top for spacing and ml for slight indent */}
                    <select
                    ...
                    >
                        <option value="1:1" className="bg-gray-800 text-white">1:1</option>
                        <option value="16:9" className="bg-gray-800 text-white">16:9</option>
                        <option value="9:16" className="bg-gray-800 text-white">9:16</option>
                    </select>
                    <FaChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white pointer-events-none" />
                </div>
