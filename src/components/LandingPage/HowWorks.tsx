...
export const HowWorks = () => {
    ...
    return (
        <div className="bg-[#010610] dark:bg-gray-900 relative" id="how-it-works">
            <img src={elipse} alt="" className="absolute right-0 dark:opacity-80" />
                ...
                <div className="max-w-[1400px] mx-auto my-auto">
                    <div className="flex flex-col gap-10 p-10">
                        ...
                        <div className="flex flex-col md:flex-row gap-10 justify-between items-center pb-8 ">
                            <div className="flex-1"><h1 className="text-6xl md:text-5xl 2xl:text-9xl text-white dark:text-white w-2/4 font-bold">How <span className="outline-text text-transparent bg-clip-text dark:text-[#A891FB]">ADELO</span> Works</h1> </div>
                            <div className="max-w-6xl mx-auto grid grid-cols-1 gap-6">
                                {processSteps.map((step) => (
                                    <div
                                        key={step.id}
                                        className="bg-[#1A1A2E] dark:bg-gray-800 rounded-xl p-8 border border-solid border-opacity-20 border-[#A891FB] dark:border-[#6749d2] shadow-lg dark:shadow-gray-700/30 flex flex-col items-start text-left"
                                    >
                                        {/* Step ID (e.g., 01, 02) */}
                                        <p className="text-[#A891FB] dark:text-[#A891FB] text-2xl font-extrabold mb-2">
                                            {step.id}
                                        </p>
                                        {/* Step Title */}
