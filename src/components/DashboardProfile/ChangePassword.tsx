...
const ChangePassword: React.FC = () => {
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900 p-4 sm:p-6 rounded-lg shadow-md mb-4 sm:mb-8 flex-1 md:w-2/4 w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
        <div>
          ...
          <input
            type="password"
            id="currentPassword"
            className={`mt-1 block w-full px-2 py-1.5 sm:px-3 sm:py-2 border rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm dark:bg-gray-800 dark:text-gray-100 ${
