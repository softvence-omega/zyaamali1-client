...
const ChangePassword: React.FC = () => {
    ...
    return (
        <div className="bg-gray-100 p-4 sm:p-6 rounded-lg shadow-md mb-4 sm:mb-8 flex-1 md:w-2/4 w-full"> {/* Adjusted padding, removed fixed width, added flex-1 */}
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4 sm:mb-6">Change Password</h2>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4"> {/* Adjusted spacing */}
                <div>
                ...
                <div>
                    <label htmlFor="confirmNewPassword" className="block text-xs sm:text-sm font-medium text-gray-700">
