...
import { FaBuilding, FaEdit, FaTrashAlt, FaChevronDown, FaChevronUp } from 'react-icons/fa';
...
import { addBusiness, updateBusiness, deleteBusiness, Business } from '../../store/Slices/BusinessSlice/ businessSlice'; // Adjust path based on your project structure  
        ...
        <div className="pb-6 border-b border-gray-200">
            ...
            <div className="space-y-4">
                {businesses.map((business: any) => (
                    <div key={business.id} className="border border-gray-200 rounded-lg p-4 bg-white shadow-sm">
                        <div className="flex justify-between items-center mb-3">
                            ...
                            <div className="flex space-x-2">
                                ...
                                >
                                    {expandedBusinessId === business.id ? <FaChevronUp /> : <FaChevronDown />}
                                </button>
                            </div>
                        </div>
