...
const AccountActions: React.FC = () => {
    ...
    const handleDeleteAccount = () => {
        if (window.confirm('Are you sure you want to permanently delete your account and all of your data? This action cannot be undone.')) {
    ...
    return (
        <div className="space-y-6">
            {/* Log Out Section */}
            <div className="bg-white p-6 rounded-lg shadow-md flex items-center space-x-3 cursor-pointer hover:bg-gray-50 transition-colors duration-200" onClick={handleLogout}>
                <FaGoogle className="text-red-500 text-2xl" /> {/* Google icon, assuming it represents the login method */}
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-sm text-gray-600 mb-4">Permanently delete your account and all of your data</p>
                <button
