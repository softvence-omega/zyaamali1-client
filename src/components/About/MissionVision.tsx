 ...
 <CommonWrapper>
     <div className="relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row min-h-screen font-sans">
        {/* Left Side */}
        <div className="bg-[#F6F3FF] dark:bg-gray-800 flex-1 flex items-center justify-center p-10 w-full">
          <img 
            src={vissionImg} 
        ...
        {/* Right Side */}
        <div className="bg-[#0C0C1D] dark:bg-gray-900 flex-1 text-white flex flex-col justify-center w-full px-4 sm:px-6 md:px-10 lg:px-16 py-12 md:py-20 space-y-12 md:space-y-24">
          {/* Mission */}
          <div className="max-w-3xl mx-auto">
            <p className="text-[#7C7AFD] dark:text-[#A891FB] text-sm mb-2 font-medium">Our Mission</p>
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#AFAFBF] dark:text-gray-300 leading-relaxed text-balance">
          ...
          {/* Vision */}
          <div className="max-w-3xl mx-auto">
            <p className="text-[#7C7AFD] dark:text-[#A891FB] text-sm mb-2 font-medium">Our Vision</p>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 leading-snug text-balance">
      ...
      <h1 className="hidden lg:flex items-center justify-center gap-4 text-3xl 2xl:text-5xl font-bold absolute bottom-10 left-[48.5%] -translate-x-1/2 leading-none text-center z-10 whitespace-nowrap">
        <span className="text-gray-800 dark:text-gray-200">Mission</span>
        <img 
          src={andImg} 
          alt="&" 
          className="w-[40px] xl:w-[50px] h-auto inline-block align-middle dark:invert dark:opacity-80" 
        />
        <span className="text-white dark:text-white">Vision</span>
      </h1>
    </div>
 </CommonWrapper>
  );
