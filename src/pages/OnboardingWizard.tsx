...
//                   {step === 1 && "Help us personalize your Adelo experience"}
//                   {step === 2 &&
...
const OnboardingWizard = () => {
  ...
  const selectedMethod = watch("businessInfoMethod");
        ...
        const response = await axios.post(
          `https://zyaamali1-backend.onrender.com/api/v1/onboarding/create`,
          {
            ...
            businessInfo: {
              method: data.businessInfoMethod,
              websiteUrl:
                data.businessInfoMethod === "website" ? data.websiteUrl : "",
              description:
                data.businessInfoMethod === "description"
