          ...
          <div className="max-w-[1400px] mx-auto ">
            ...
            <div className="flex flex-col md:flex-row items-center  mb-20">
              <div className="md:w-1/2">
                ...
                <h3 className="font-bold text-T-900 dark:text-white text-3xl sm:text-4xl mb-3">
                  Provide Your Campaign Goals & Audience Details
                </h3>
                <p className="text-T-600 dark:text-gray-300 text-base sm:text-lg">
                  Start by sharing key details about your business, campaign
                  objectives, and target audience. Whether you want to drive
                  sales, increase brand awareness, or generate leads, Sterling
                  tailors your content to align with your goals.
                </p>
              </div>
              <div className="md:w-1/2">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12 mb-20">
              <div className="md:w-1/2">
                ...
                <p className="text-T-600 dark:text-gray-300 text-base sm:text-lg">
                  Our AI assistant, Sterling, generates personalized content for
                  you—whether it's ad copy, email subject lines, social media
                  posts, or landing page text. The content is crafted to match
                  your brand tone and the specific requirements of each
                  platform.
                </p>
              </div>
              <div className="md:w-1/2">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
              <div className="md:w-1/2">
                ...
                <p className="text-T-600 dark:text-gray-300 text-base sm:text-lg">
                  You can review and customize the generated content. Add your
                  personal touch, adjust tone, or make minor edits to ensure the
                  message aligns perfectly with your vision.
                </p>
              </div>
              <div className="md:w-1/2">
                <img
