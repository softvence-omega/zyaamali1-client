    ...
    <div>
      <nav className="flex justify-between items-center mx-5  ">
        ...
        <div className="flex items-center space-x-3">
          <PrimaryButton icon={<PiShareFat className="text-lg" />}>
            {" "}
            Share
          </PrimaryButton>
          <button className="bg-[#654FAE] p-3 rounded-full">
          ...
          <div className="flex flex-1">
            ...
            <aside className="w-90 p-6  border-gray-700 flex flex-col space-y-8">
              <div className=" bg-T-300 p-4 rounded-lg ">
                <h3 className="text-lg font-semibold mb-3 text-T-400">
                  Prompt
                </h3>
                <textarea
