...
const items = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur. Senectus augue rhoncus molestie egestas dignissim blandit posuere. Etiam tortor semper dignissim faucibus. Metus amet viverra diam lorem velit. Sed id ultricies aliquam vitae dui mauris mi integer.",
  },
  {
    icon: light,
    title: "Maximize Your Social Media Engagement",
    description:
      "Engaging with your audience on social media is crucial for brand loyalty. Create compelling content that resonates with your followers. Utilize insights and analytics to tailor your strategy and foster a vibrant online community.",
  },
  {
    icon: light,
    title: "Enhance Your Email Marketing Strategy",
    description:
      "Email marketing remains one of the most effective channels for reaching customers. Personalization and segmentation can dramatically improve open rates. Consider A/B testing subject lines and content formats to optimize performance.",
  },
  {
    icon: light,
    title: "Leverage Influencer Partnerships",
    description:
      "Influencer marketing can amplify your brand's visibility. Collaborate with influencers who align with your values and audience. Authentic partnerships can lead to increased trust and greater conversion rates.",
  },
];
...
const DashboardAnalytics = () => {
  return (
    <div className="overflow-x-hidden px-4 sm:px-6 lg:px-8 py-6">
      ...
      <p className="text-T-400 mt-3 ">
        Monitor & Analyse your marketing performence{" "}
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 sm:gap-5 lg:gap-6 mt-4 sm:mt-6">
        {statItems.map(({ title, icon, amount, percentage }, index) => {
          ...
          const isTrulyPositive =
            percentage.startsWith("+") && numericValue >= 1;

          const TrendIcon = isTrulyPositive ? ArrowUp : ArrowDown;
          const colorClass = isTrulyPositive
            ? "text-green-400"
            : "text-red-400";
        ...
        <div className="w-full md:w-1/2 bg-T-300 dark:bg-[#1e2939] dark:text-gray-300 rounded-md">
          <div className="rounded-xl shadow-sm mx-auto">
            ...
            <div className="flex justify-between items-center p-3">
              <h2 className="text-xl text-black dark:text-gray-300">Platform Breakdown</h2>
              <a href="#" className="text-sm text-violet-600 dark:text-gray-300 font-medium">
                View All
              </a>
            </div>
            ...
            <div className="px-2 rounded-xl space-y-4">
              {platforms.map((p, idx) => (
                <div key={idx} className="bg-white dark:bg-[#1e2939] dark:text-gray-300 rounded-lg shadow-sm">
                  <div className="flex justify-between items-center p-2">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">{p.campaigns}</p>
                      </div>
                    </div>
                  ...
                  <div className="flex justify-between pl-5 md:pl-10 pb-2 text-sm text-gray-500">
                    <div className="pl-5 md:pl-0">
                      ...
                      <p className="text-gray-700 dark:text-gray-400">{p.impression}</p>
                    </div>
                    <div>
                      <p className="dark:text-gray-300">Clicks</p>
                      <p className="text-gray-700 dark:text-gray-400">{p.clicks}</p>
                    </div>
                    <div className="flex flex-col items-center pr-2">
                      <p className="dark:text-gray-300">ROAS</p>
                      <p className={`font-semibold dark:text-gray-400 ${p.roasColor}`}>{p.roas}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <div className="mt-5 bg-T-200 dark:bg-[#1e2939]  pb-5 rounded-md">
        <div className="flex justify-between my-5 mx-5 pt-4">
          <h1 className="text-xl text-black dark:text-gray-300">Campaign Performance</h1>
          ...
          <Table>
            ...
            <TableBody>
              {campaignData.map((campaign, index) => (
                <TableRow key={index} className="text-[10px] dark:text-gray-300 md:text-[16px]">
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-white text-[14px] text-sm w-2/3">
                  {item.description}
                </p>
              </div>
            </div>
